...
- **Thermal paste.** Don't use Thermal Grizzly Kryonaut, it's made for sub-zero overclocking and dries out quickly. Use a thick paste like **Arctic MX-7** instead. MX-7 is so far the most recommended by many users for repasting these cards. **Important:** not all cards are flat with the memory, so you need a thick thermal interface. Best is a phase-change pad like **PTM7950** if you can get one, otherwise you can see hotspot temps of about +40 °C above the median.
...
For help and discussion with other gfx906 owners, join the gfx906 Discord: https://discord.gg/2dq4wQgJ2m
